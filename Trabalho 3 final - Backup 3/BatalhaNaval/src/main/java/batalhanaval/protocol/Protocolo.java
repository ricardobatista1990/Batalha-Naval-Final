...
public class Protocolo {
    ...
    /** Jogo retomado após carregamento: JOGO_RETOMADO|nomeAdversario|meuTabuleiro|tabAdversario|jogadorAtual */
    public static final String JOGO_RETOMADO = "JOGO_RETOMADO";
